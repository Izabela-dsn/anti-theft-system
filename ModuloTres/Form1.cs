...
namespace ModuloTres
{
    public partial class Form1 : Form
    {
        ...
        private static List<Tuple<double, double>> HandleMap()
        {
            ...
            {
               Tuple.Create(-18.90638060788791, -48.23601196678411),// Parque do Sabi�
        ...
        private void LoadMap(List<Tuple<double, double>> coordinates)
        {
            ...
            {
                MessageBox.Show("O controle WebView2 n�o p�de ser inicializado.");
            }
        }
        ...
        private void LoadGraphs(Dictionary<string, double> medidas)
        {
            ...
            Series series = chart.Series.Add("Minha S�rie");
            series.ChartType = SeriesChartType.Line;

            // Adicionando os pontos ao gr�fico
